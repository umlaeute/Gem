...
void vertex_scale :: scaleMess(int argc, t_atom*argv){
  m_w=1.f;
...
{ 
  class_addmethod(classPtr, (t_method)&vertex_scale::scaleMessCallback,
...
void vertex_scale :: scaleMessCallback(void *data, t_symbol*, int argc, t_atom*argv)
{
  GetMyClass(data)->scaleMess(argc, argv);
}
