...
#define GETSETENUMVAL(T)                                                \
  ...
  std::map<std::string, t_getenum>map_getenum; /* dummy map */
  std::map<std::string, t_setenum>map_setenum; /* dummy map */
  std::map<std::string, t_setenumi>map_setenumi; /* dummy map */
