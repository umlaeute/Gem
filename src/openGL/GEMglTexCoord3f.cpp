...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglTexCoord3f, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglTexCoord3f :: GEMglTexCoord3f      (t_floatarg arg0, t_floatarg arg1,
    t_floatarg arg2) :
...
void GEMglTexCoord3f :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord3f::sMessCallback),
                  gensym("s"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord3f::tMessCallback),
                  gensym("t"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord3f::rMessCallback),
                  gensym("r"), A_DEFFLOAT, A_NULL);
};

void GEMglTexCoord3f :: sMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->sMess ( static_cast<t_float>(arg0));
}
void GEMglTexCoord3f :: tMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->tMess ( static_cast<t_float>(arg0));
}
void GEMglTexCoord3f :: rMessCallback (void* data, t_float arg0)
{
