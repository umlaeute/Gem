...
#ifndef _INCLUDE__GEM_OPENGL_GEMGLMULTITEXCOORD2FARB_H_
#define _INCLUDE__GEM_OPENGL_GEMGLMULTITEXCOORD2FARB_H_
...
class GEM_EXTERN GEMglMultiTexCoord2f : public GemGLBase
{
  CPPEXTERN_HEADER(GEMglMultiTexCoord2f, GemGLBase);

public:
  // Constructor
  GEMglMultiTexCoord2f (t_float, t_float, t_float);  // CON

protected:
  // Destructor
  virtual ~GEMglMultiTexCoord2f ();
  // check extensions
