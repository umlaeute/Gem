...
A wrapper for "glNormal3fv (GLfloat* v)"
...
CLASS
    ...
    A Wrapper for the openGL-command "glNormal3fv (GLfloat* v)"
...
class GEM_EXTERN GEMglNormal3fv : public GemBase
{
    ...
    public:
        ...
        //////////
        // Constructor
        GEMglNormal3fv  (t_floatarg, t_floatarg, t_floatarg);         // CON
	...
	virtual~GEMglNormal3fv();
	 ...
	 GLfloat m_v[3];		// VAR
	virtual void	vMess 	 (t_float, t_float, t_float);		// FUN glNormal3fv GLfloat*
