...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglTexParameterf, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglTexParameterf :: GEMglTexParameterf        (t_floatarg arg0,
...
void GEMglTexParameterf :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexParameterf::targetMessCallback),
                  gensym("target"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexParameterf::pnameMessCallback),
                  gensym("pname"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexParameterf::paramMessCallback),
