...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglRasterPos3s, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglRasterPos3s :: GEMglRasterPos3s    (t_floatarg arg0, t_floatarg arg1,
    t_floatarg arg2) :
...
void GEMglRasterPos3s :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos3s::xMessCallback),
                  gensym("x"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos3s::yMessCallback),
                  gensym("y"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos3s::zMessCallback),
                  gensym("z"), A_DEFFLOAT, A_NULL);
};

void GEMglRasterPos3s :: xMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->xMess ( static_cast<t_float>(arg0));
}
void GEMglRasterPos3s :: yMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->yMess ( static_cast<t_float>(arg0));
}
void GEMglRasterPos3s :: zMessCallback (void* data, t_float arg0)
{
