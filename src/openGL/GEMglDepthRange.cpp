...
CPPEXTERN_NEW_WITH_TWO_ARGS ( GEMglDepthRange, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglDepthRange :: GEMglDepthRange      (t_floatarg arg0,
    t_floatarg arg1) :
...
void GEMglDepthRange :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglDepthRange::near_valMessCallback),
                  gensym("near_val"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglDepthRange::far_valMessCallback),
                  gensym("far_val"), A_DEFFLOAT, A_NULL);
};
