...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglTexEnvf, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglTexEnvf :: GEMglTexEnvf    (t_floatarg arg0, t_floatarg arg1,
                                 t_floatarg arg2) :
...
void GEMglTexEnvf :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexEnvf::targetMessCallback),
                  gensym("target"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexEnvf::pnameMessCallback),
                  gensym("pname"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexEnvf::paramMessCallback),
                  gensym("param"), A_DEFFLOAT, A_NULL);
};

void GEMglTexEnvf :: targetMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->targetMess ( static_cast<t_float>(arg0));
}
void GEMglTexEnvf :: pnameMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->pnameMess ( static_cast<t_float>(arg0));
}
void GEMglTexEnvf :: paramMessCallback (void* data, t_float arg0)
{
