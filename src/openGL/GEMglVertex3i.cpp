...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglVertex3i, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglVertex3i :: GEMglVertex3i  (t_floatarg arg0, t_floatarg arg1,
                                 t_floatarg arg2) :
...
void GEMglVertex3i :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex3i::xMessCallback),   gensym("x"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex3i::yMessCallback),   gensym("y"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex3i::zMessCallback),   gensym("z"),
                  A_DEFFLOAT, A_NULL);
};

void GEMglVertex3i :: xMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->xMess ( static_cast<t_float>(arg0));
}
void GEMglVertex3i :: yMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->yMess ( static_cast<t_float>(arg0));
}
void GEMglVertex3i :: zMessCallback (void* data, t_float arg0)
{
