...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglProgramEnvParameter4fvARB, t_floatarg,
...
// Variables
//
void GEMglProgramEnvParameter4fvARB :: targetMess (t_float
    arg1)        // FUN
{
...
void GEMglProgramEnvParameter4fvARB :: indexMess (t_float
    arg1)         // FUN
{
  index = static_cast<GLenum>(arg1);
  setModified();
...
void GEMglProgramEnvParameter4fvARB :: paramsMess (int argc,
    t_atom*argv)       // FUN
{
  if(argc!=4) {
...
void GEMglProgramEnvParameter4fvARB :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  ...
                  (&GEMglProgramEnvParameter4fvARB::targetMessCallback),
                  gensym("target"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>
                  (&GEMglProgramEnvParameter4fvARB::indexMessCallback),      gensym("index"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>
                  (&GEMglProgramEnvParameter4fvARB::paramsMessCallback),
                  gensym("params"), A_GIMME, A_NULL);
};

void GEMglProgramEnvParameter4fvARB :: targetMessCallback (void* data,
    t_float arg0)
{
  GetMyClass(data)->targetMess ( static_cast<t_float>(arg0));
}
void GEMglProgramEnvParameter4fvARB :: indexMessCallback (void* data,
    t_float arg0)
{
  GetMyClass(data)->indexMess ( static_cast<t_float>(arg0));
}
void GEMglProgramEnvParameter4fvARB :: paramsMessCallback (void* data,
