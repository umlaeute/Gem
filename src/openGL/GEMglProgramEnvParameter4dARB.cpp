...
// Constructor
//
GEMglProgramEnvParameter4dARB :: GEMglProgramEnvParameter4dARB  (int argc,
    t_atom*argv ) :
  target(0), index(0),
...
// Variables
//
void GEMglProgramEnvParameter4dARB :: targetMess (t_float
    arg1)         // FUN
{
...
void GEMglProgramEnvParameter4dARB :: indexMess (t_float
    arg2)          // FUN
{
...
void GEMglProgramEnvParameter4dARB :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  ...
                  (&GEMglProgramEnvParameter4dARB::targetMessCallback),
                  gensym("target"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>
                  (&GEMglProgramEnvParameter4dARB::indexMessCallback),       gensym("index"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglProgramEnvParameter4dARB::xMessCallback),
                  gensym("x"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglProgramEnvParameter4dARB::yMessCallback),
                  gensym("y"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglProgramEnvParameter4dARB::zMessCallback),
                  gensym("z"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglProgramEnvParameter4dARB::wMessCallback),
                  gensym("w"), A_DEFFLOAT, A_NULL);
};

void GEMglProgramEnvParameter4dARB :: targetMessCallback (void* data,
    t_float arg0)
{
  GetMyClass(data)->targetMess ( static_cast<t_float>(arg0));
}
void GEMglProgramEnvParameter4dARB :: indexMessCallback (void* data,
    t_float arg1)
{
  GetMyClass(data)->indexMess ( static_cast<t_float>(arg1));
}
void GEMglProgramEnvParameter4dARB :: xMessCallback (void* data,
    t_float arg2)
{
  GetMyClass(data)->xMess ( static_cast<t_float>(arg2));
}
void GEMglProgramEnvParameter4dARB :: yMessCallback (void* data,
    t_float arg3)
{
  GetMyClass(data)->yMess ( static_cast<t_float>(arg3));
}
void GEMglProgramEnvParameter4dARB :: zMessCallback (void* data,
    t_float arg4)
{
  GetMyClass(data)->zMess ( static_cast<t_float>(arg4));
}
void GEMglProgramEnvParameter4dARB :: wMessCallback (void* data,
    t_float arg5)
{
