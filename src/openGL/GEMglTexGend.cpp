...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglTexGend, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglTexGend :: GEMglTexGend    (t_floatarg arg0, t_floatarg arg1,
                                 t_floatarg arg2) :
...
void GEMglTexGend :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexGend::coordMessCallback),
                  gensym("coord"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexGend::pnameMessCallback),
                  gensym("pname"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexGend::paramMessCallback),
                  gensym("param"), A_DEFFLOAT, A_NULL);
};

void GEMglTexGend :: coordMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->coordMess ( static_cast<t_float>(arg0));
}
void GEMglTexGend :: pnameMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->pnameMess ( static_cast<t_float>(arg0));
}
void GEMglTexGend :: paramMessCallback (void* data, t_float arg0)
{
