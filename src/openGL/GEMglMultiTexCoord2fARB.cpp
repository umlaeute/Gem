...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglMultiTexCoord2fARB, t_floatarg,
...
// Constructor
//
GEMglMultiTexCoord2fARB :: GEMglMultiTexCoord2fARB      (t_floatarg arg0,
...
void GEMglMultiTexCoord2fARB :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglMultiTexCoord2fARB::texUnitMessCallback),
                  gensym("texUnit"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglMultiTexCoord2fARB::sMessCallback),
                  gensym("s"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglMultiTexCoord2fARB::tMessCallback),
                  gensym("t"), A_DEFFLOAT, A_NULL);
};

void GEMglMultiTexCoord2fARB :: texUnitMessCallback (void* data,
    t_float arg0)
{
