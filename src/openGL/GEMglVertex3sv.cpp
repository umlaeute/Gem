...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglVertex3sv, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglVertex3sv :: GEMglVertex3sv        (t_floatarg arg0, t_floatarg arg1,
    t_floatarg arg2)
{
...
// variable
//
void GEMglVertex3sv :: vMess (t_float arg0, t_float arg1,
                              t_float arg2)         // FUN
{
...
void GEMglVertex3sv :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex3sv::vMessCallback),
                  gensym("v"), A_DEFFLOAT, A_DEFFLOAT, A_DEFFLOAT, A_NULL);
}

void GEMglVertex3sv :: vMessCallback (void* data, t_float arg0,
