...
CPPEXTERN_NEW_WITH_TWO_ARGS ( GEMglLightModelf, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglLightModelf :: GEMglLightModelf    (t_floatarg arg0,
    t_floatarg arg1) :
...
void GEMglLightModelf :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglLightModelf::pnameMessCallback),
                  gensym("pname"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglLightModelf::paramMessCallback),
