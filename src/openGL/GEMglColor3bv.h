...
A wrapper for "glColor3bv (GLbyte* v)"
...
CLASS
    ...
    A Wrapper for the openGL-command "glColor3bv (GLbyte* v)"
...
class GEM_EXTERN GEMglColor3bv : public GemBase
{
    ...
    public:
        ...
        //////////
        // Constructor
        GEMglColor3bv  (t_floatarg, t_floatarg, t_floatarg);         // CON
	...
	virtual~GEMglColor3bv();
	 ...
	 GLbyte m_v[3];		// VAR
	virtual void	vMess 	 (t_float, t_float, t_float);		// FUN glColor3bv GLbyte*
