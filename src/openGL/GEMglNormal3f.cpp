...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglNormal3f, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglNormal3f :: GEMglNormal3f  (t_floatarg arg0, t_floatarg arg1,
                                 t_floatarg arg2) :
...
void GEMglNormal3f :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglNormal3f::nxMessCallback),
                  gensym("nx"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglNormal3f::nyMessCallback),
                  gensym("ny"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglNormal3f::nzMessCallback),
                  gensym("nz"), A_DEFFLOAT, A_NULL);
};

void GEMglNormal3f :: nxMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->nxMess ( static_cast<t_float>(arg0));
}
void GEMglNormal3f :: nyMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->nyMess ( static_cast<t_float>(arg0));
}
void GEMglNormal3f :: nzMessCallback (void* data, t_float arg0)
{
