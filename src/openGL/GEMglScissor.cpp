...
CPPEXTERN_NEW_WITH_FOUR_ARGS ( GEMglScissor, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglScissor :: GEMglScissor    (t_floatarg arg0, t_floatarg arg1,
...
void GEMglScissor :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglScissor::xMessCallback),    gensym("x"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglScissor::yMessCallback),    gensym("y"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglScissor::widthMessCallback),
                  gensym("width"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglScissor::heightMessCallback),
