...
CPPEXTERN_NEW_WITH_FOUR_ARGS ( GEMglColor4dv, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglColor4dv :: GEMglColor4dv  (t_floatarg arg0, t_floatarg arg1,
...
// variable
//
void GEMglColor4dv :: vMess (t_float arg0, t_float arg1, t_float arg2,
                             t_float arg3)    // FUN
{
...
void GEMglColor4dv :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglColor4dv::vMessCallback),   gensym("v"),
                  A_DEFFLOAT, A_DEFFLOAT, A_DEFFLOAT, A_DEFFLOAT, A_NULL);
}

void GEMglColor4dv :: vMessCallback (void* data, t_float arg0,
