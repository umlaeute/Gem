...
A wrapper for "glVertex3dv (GLdouble* v)"
...
CLASS
    ...
    A Wrapper for the openGL-command "glVertex3dv (GLdouble* v)"
...
class GEM_EXTERN GEMglVertex3dv : public GemBase
{
    ...
    public:
        ...
        //////////
        // Constructor
        GEMglVertex3dv  (t_floatarg, t_floatarg, t_floatarg);         // CON
	...
	virtual~GEMglVertex3dv();
	 ...
	 GLdouble m_v[3];		// VAR
	virtual void	vMess 	 (t_float, t_float, t_float);		// FUN glVertex3dv GLdouble*
