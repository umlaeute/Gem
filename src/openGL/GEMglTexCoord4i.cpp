...
CPPEXTERN_NEW_WITH_FOUR_ARGS ( GEMglTexCoord4i, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglTexCoord4i :: GEMglTexCoord4i      (t_floatarg arg0, t_floatarg arg1,
...
void GEMglTexCoord4i :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord4i::sMessCallback),
                  gensym("s"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord4i::tMessCallback),
                  gensym("t"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord4i::rMessCallback),
                  gensym("r"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord4i::qMessCallback),
                  gensym("q"), A_DEFFLOAT, A_NULL);
};

void GEMglTexCoord4i :: sMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->sMess ( static_cast<t_float>(arg0));
}
void GEMglTexCoord4i :: tMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->tMess ( static_cast<t_float>(arg0));
}
void GEMglTexCoord4i :: rMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->rMess ( static_cast<t_float>(arg0));
}
void GEMglTexCoord4i :: qMessCallback (void* data, t_float arg0)
{
