...
CPPEXTERN_NEW_WITH_TWO_ARGS ( GEMglRasterPos2i, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglRasterPos2i :: GEMglRasterPos2i    (t_floatarg arg0,
    t_floatarg arg1) :
...
void GEMglRasterPos2i :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos2i::xMessCallback),
                  gensym("x"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos2i::yMessCallback),
                  gensym("y"), A_DEFFLOAT, A_NULL);
};

void GEMglRasterPos2i :: xMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->xMess ( static_cast<t_float>(arg0));
}
void GEMglRasterPos2i :: yMessCallback (void* data, t_float arg0)
{
