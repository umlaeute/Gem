...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglVertex3f, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglVertex3f :: GEMglVertex3f  (t_floatarg arg0, t_floatarg arg1,
                                 t_floatarg arg2) :
...
void GEMglVertex3f :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex3f::xMessCallback),   gensym("x"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex3f::yMessCallback),   gensym("y"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex3f::zMessCallback),   gensym("z"),
                  A_DEFFLOAT, A_NULL);
};

void GEMglVertex3f :: xMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->xMess ( static_cast<t_float>(arg0));
}
void GEMglVertex3f :: yMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->yMess ( static_cast<t_float>(arg0));
}
void GEMglVertex3f :: zMessCallback (void* data, t_float arg0)
{
