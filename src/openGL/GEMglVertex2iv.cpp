...
CPPEXTERN_NEW_WITH_TWO_ARGS ( GEMglVertex2iv, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglVertex2iv :: GEMglVertex2iv        (t_floatarg arg0, t_floatarg arg1)
{
  vMess(arg0, arg1);
...
void GEMglVertex2iv :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex2iv::vMessCallback),
                  gensym("v"), A_DEFFLOAT, A_DEFFLOAT, A_NULL);
}

void GEMglVertex2iv :: vMessCallback (void* data, t_float arg0,
                                      t_float arg1)
{
