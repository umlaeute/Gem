...
CPPEXTERN_NEW_WITH_FOUR_ARGS ( GEMglVertex4s, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglVertex4s :: GEMglVertex4s  (t_floatarg arg0, t_floatarg arg1,
...
void GEMglVertex4s :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex4s::xMessCallback),   gensym("x"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex4s::yMessCallback),   gensym("y"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex4s::zMessCallback),   gensym("z"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex4s::wMessCallback),   gensym("w"),
                  A_DEFFLOAT, A_NULL);
};
