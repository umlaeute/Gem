...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglRasterPos3iv, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglRasterPos3iv :: GEMglRasterPos3iv  (t_floatarg arg0, t_floatarg arg1,
    t_floatarg arg2)
{
...
// variable
//
void GEMglRasterPos3iv :: vMess (t_float arg0, t_float arg1,
                                 t_float arg2)      // FUN
{
...
void GEMglRasterPos3iv :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos3iv::vMessCallback),
                  gensym("v"), A_DEFFLOAT, A_DEFFLOAT, A_DEFFLOAT, A_NULL);
}

void GEMglRasterPos3iv :: vMessCallback (void* data, t_float arg0,
