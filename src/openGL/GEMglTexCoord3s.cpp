...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglTexCoord3s, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglTexCoord3s :: GEMglTexCoord3s      (t_floatarg arg0, t_floatarg arg1,
    t_floatarg arg2) :
...
void GEMglTexCoord3s :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord3s::sMessCallback),
                  gensym("s"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord3s::tMessCallback),
                  gensym("t"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord3s::rMessCallback),
                  gensym("r"), A_DEFFLOAT, A_NULL);
};

void GEMglTexCoord3s :: sMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->sMess ( static_cast<t_float>(arg0));
}
void GEMglTexCoord3s :: tMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->tMess ( static_cast<t_float>(arg0));
}
void GEMglTexCoord3s :: rMessCallback (void* data, t_float arg0)
{
