...
void GEMglVertex2s :: obj_setupCallback(t_class *classPtr) {
	 class_addmethod(classPtr, (t_method)&GEMglVertex2s::xMessCallback,  	gensym("x"), A_DEFFLOAT, A_NULL);
	 class_addmethod(classPtr, (t_method)&GEMglVertex2s::yMessCallback,  	gensym("y"), A_DEFFLOAT, A_NULL);
};
