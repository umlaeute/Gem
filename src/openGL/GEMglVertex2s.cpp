...
CPPEXTERN_NEW_WITH_TWO_ARGS ( GEMglVertex2s, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglVertex2s :: GEMglVertex2s  (t_floatarg arg0, t_floatarg arg1) :
...
void GEMglVertex2s :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex2s::xMessCallback),   gensym("x"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex2s::yMessCallback),   gensym("y"),
                  A_DEFFLOAT, A_NULL);
};

void GEMglVertex2s :: xMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->xMess ( static_cast<t_float>(arg0));
}
void GEMglVertex2s :: yMessCallback (void* data, t_float arg0)
{
