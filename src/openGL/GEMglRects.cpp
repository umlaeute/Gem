...
CPPEXTERN_NEW_WITH_FOUR_ARGS ( GEMglRects, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglRects :: GEMglRects        (t_floatarg arg0, t_floatarg arg1,
...
void GEMglRects :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRects::x1MessCallback),     gensym("x1"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRects::y1MessCallback),     gensym("y1"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRects::x2MessCallback),     gensym("x2"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRects::y2MessCallback),     gensym("y2"),
                  A_DEFFLOAT, A_NULL);
};

void GEMglRects :: x1MessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->x1Mess ( static_cast<t_float>(arg0));
}
void GEMglRects :: y1MessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->y1Mess ( static_cast<t_float>(arg0));
}
void GEMglRects :: x2MessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->x2Mess ( static_cast<t_float>(arg0));
}
void GEMglRects :: y2MessCallback (void* data, t_float arg0)
{
