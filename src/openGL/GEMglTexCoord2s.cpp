...
CPPEXTERN_NEW_WITH_TWO_ARGS ( GEMglTexCoord2s, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglTexCoord2s :: GEMglTexCoord2s      (t_floatarg arg0,
    t_floatarg arg1) :
...
void GEMglTexCoord2s :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord2s::sMessCallback),
                  gensym("s"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord2s::tMessCallback),
                  gensym("t"), A_DEFFLOAT, A_NULL);
};

void GEMglTexCoord2s :: sMessCallback (void* data, t_float arg0)
{
