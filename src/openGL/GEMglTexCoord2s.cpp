...
void GEMglTexCoord2s :: obj_setupCallback(t_class *classPtr) {
	 class_addmethod(classPtr, (t_method)&GEMglTexCoord2s::sMessCallback,  	gensym("s"), A_DEFFLOAT, A_NULL);
	 class_addmethod(classPtr, (t_method)&GEMglTexCoord2s::tMessCallback,  	gensym("t"), A_DEFFLOAT, A_NULL);
};
