...
#ifndef INCLUDE_GEM_GLCOPYTEXIMAGE1D_H_
#define INCLUDE_GEM_GLCOPYTEXIMAGE1D_H_
...
class GEM_EXTERN GEMglCopyTexImage1D : public GemBase
{
	CPPEXTERN_HEADER(GEMglCopyTexImage1D, GemBase)
