...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglRasterPos3d, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglRasterPos3d :: GEMglRasterPos3d    (t_floatarg arg0, t_floatarg arg1,
    t_floatarg arg2) :
...
void GEMglRasterPos3d :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos3d::xMessCallback),
                  gensym("x"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos3d::yMessCallback),
                  gensym("y"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos3d::zMessCallback),
                  gensym("z"), A_DEFFLOAT, A_NULL);
};

void GEMglRasterPos3d :: xMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->xMess ( static_cast<t_float>(arg0));
}
void GEMglRasterPos3d :: yMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->yMess ( static_cast<t_float>(arg0));
}
void GEMglRasterPos3d :: zMessCallback (void* data, t_float arg0)
{
