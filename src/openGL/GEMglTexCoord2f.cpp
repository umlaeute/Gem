...
CPPEXTERN_NEW_WITH_TWO_ARGS ( GEMglTexCoord2f, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglTexCoord2f :: GEMglTexCoord2f      (t_floatarg arg0,
    t_floatarg arg1) :
...
void GEMglTexCoord2f :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord2f::sMessCallback),
                  gensym("s"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord2f::tMessCallback),
                  gensym("t"), A_DEFFLOAT, A_NULL);
};

void GEMglTexCoord2f :: sMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->sMess ( static_cast<t_float>(arg0));
}
void GEMglTexCoord2f :: tMessCallback (void* data, t_float arg0)
{
