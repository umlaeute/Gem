...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglTexCoord3d, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglTexCoord3d :: GEMglTexCoord3d      (t_floatarg arg0, t_floatarg arg1,
    t_floatarg arg2) :
...
void GEMglTexCoord3d :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord3d::sMessCallback),
                  gensym("s"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord3d::tMessCallback),
                  gensym("t"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord3d::rMessCallback),
                  gensym("r"), A_DEFFLOAT, A_NULL);
};

void GEMglTexCoord3d :: sMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->sMess ( static_cast<t_float>(arg0));
}
void GEMglTexCoord3d :: tMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->tMess ( static_cast<t_float>(arg0));
}
void GEMglTexCoord3d :: rMessCallback (void* data, t_float arg0)
{
