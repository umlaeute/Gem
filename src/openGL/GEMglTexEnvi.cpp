...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglTexEnvi, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglTexEnvi :: GEMglTexEnvi    (t_floatarg arg0, t_floatarg arg1,
                                 t_floatarg arg2) :
...
void GEMglTexEnvi :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexEnvi::targetMessCallback),
                  gensym("target"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexEnvi::pnameMessCallback),
                  gensym("pname"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexEnvi::paramMessCallback),
