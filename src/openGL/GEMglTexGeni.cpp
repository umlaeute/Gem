...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglTexGeni, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglTexGeni :: GEMglTexGeni    (t_floatarg arg0, t_floatarg arg1,
                                 t_floatarg arg2) :
...
void GEMglTexGeni :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexGeni::coordMessCallback),
                  gensym("coord"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexGeni::pnameMessCallback),
                  gensym("pname"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexGeni::paramMessCallback),
                  gensym("param"), A_DEFFLOAT, A_NULL);
};

void GEMglTexGeni :: coordMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->coordMess ( static_cast<t_float>(arg0));
}
void GEMglTexGeni :: pnameMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->pnameMess ( static_cast<t_float>(arg0));
}
void GEMglTexGeni :: paramMessCallback (void* data, t_float arg0)
{
