...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglTranslatef, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglTranslatef :: GEMglTranslatef      (t_floatarg arg0, t_floatarg arg1,
    t_floatarg arg2) :
...
void GEMglTranslatef :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTranslatef::xMessCallback),
                  gensym("x"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTranslatef::yMessCallback),
                  gensym("y"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTranslatef::zMessCallback),
