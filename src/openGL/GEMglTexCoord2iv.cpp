...
CPPEXTERN_NEW_WITH_TWO_ARGS ( GEMglTexCoord2iv, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglTexCoord2iv :: GEMglTexCoord2iv    (t_floatarg arg0, t_floatarg arg1)
{
  vMess(arg0, arg1);
...
void GEMglTexCoord2iv :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord2iv::vMessCallback),
                  gensym("v"), A_DEFFLOAT, A_DEFFLOAT, A_NULL);
}

void GEMglTexCoord2iv :: vMessCallback (void* data, t_float arg0,
                                        t_float arg1)
{
