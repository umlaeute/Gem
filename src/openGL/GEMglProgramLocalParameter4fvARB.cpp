...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglProgramLocalParameter4fvARB,
...
GEMglProgramLocalParameter4fvARB :: GEMglProgramLocalParameter4fvARB    (
  t_floatarg arg0, t_floatarg arg1, t_floatarg arg2) :
...
// Variables
//
void GEMglProgramLocalParameter4fvARB :: targetMess (
  t_float arg1)      // FUN
{
...
void GEMglProgramLocalParameter4fvARB :: indexMess (t_float
    arg1)       // FUN
{
  index = static_cast<GLenum>(arg1);
  setModified();
...
void GEMglProgramLocalParameter4fvARB :: paramsMess (int argc,
    t_atom*argv)     // FUN
{
  if(argc!=4) {
...
void GEMglProgramLocalParameter4fvARB :: obj_setupCallback(
  t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>
                  (&GEMglProgramLocalParameter4fvARB::targetMessCallback),
                  gensym("target"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>
                  (&GEMglProgramLocalParameter4fvARB::indexMessCallback),    gensym("index"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>
                  (&GEMglProgramLocalParameter4fvARB::paramsMessCallback),
                  gensym("params"), A_GIMME, A_NULL);
};

void GEMglProgramLocalParameter4fvARB :: targetMessCallback (void* data,
    t_float arg0)
{
  GetMyClass(data)->targetMess ( static_cast<t_float>(arg0));
}
void GEMglProgramLocalParameter4fvARB :: indexMessCallback (void* data,
    t_float arg0)
{
  GetMyClass(data)->indexMess ( static_cast<t_float>(arg0));
}
void GEMglProgramLocalParameter4fvARB :: paramsMessCallback (void* data,
