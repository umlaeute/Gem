...
CPPEXTERN_NEW_WITH_TWO_ARGS ( GEMglRasterPos2dv, t_floatarg, A_DEFFLOAT,
...
void GEMglRasterPos2dv :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos2dv::vMessCallback),
                  gensym("v"), A_DEFFLOAT, A_DEFFLOAT, A_NULL);
}

void GEMglRasterPos2dv :: vMessCallback (void* data, t_float arg0,
    t_float arg1)
{
