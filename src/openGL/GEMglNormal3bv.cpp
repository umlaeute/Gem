...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglNormal3bv, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglNormal3bv :: GEMglNormal3bv        (t_floatarg arg0, t_floatarg arg1,
    t_floatarg arg2)
{
...
// variable
//
void GEMglNormal3bv :: vMess (t_float arg0, t_float arg1,
                              t_float arg2)         // FUN
{
...
void GEMglNormal3bv :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglNormal3bv::vMessCallback),
                  gensym("v"), A_DEFFLOAT, A_DEFFLOAT, A_DEFFLOAT, A_NULL);
}

void GEMglNormal3bv :: vMessCallback (void* data, t_float arg0,
