...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglNormal3dv, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglNormal3dv :: GEMglNormal3dv        (t_floatarg arg0, t_floatarg arg1,
    t_floatarg arg2)
{
...
// variable
//
void GEMglNormal3dv :: vMess (t_float arg0, t_float arg1,
                              t_float arg2)         // FUN
{
...
void GEMglNormal3dv :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglNormal3dv::vMessCallback),
                  gensym("v"), A_DEFFLOAT, A_DEFFLOAT, A_DEFFLOAT, A_NULL);
}

void GEMglNormal3dv :: vMessCallback (void* data, t_float arg0,
