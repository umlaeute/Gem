...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglNormal3s, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglNormal3s :: GEMglNormal3s  (t_floatarg arg0, t_floatarg arg1,
                                 t_floatarg arg2) :
...
void GEMglNormal3s :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglNormal3s::nxMessCallback),
                  gensym("nx"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglNormal3s::nyMessCallback),
                  gensym("ny"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglNormal3s::nzMessCallback),
                  gensym("nz"), A_DEFFLOAT, A_NULL);
};

void GEMglNormal3s :: nxMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->nxMess ( static_cast<t_float>(arg0));
}
void GEMglNormal3s :: nyMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->nyMess ( static_cast<t_float>(arg0));
}
void GEMglNormal3s :: nzMessCallback (void* data, t_float arg0)
{
