...
void GEMglPixelStoref :: obj_setupCallback(t_class *classPtr) {
	 class_addmethod(classPtr, (t_method)&GEMglPixelStoref::pnameMessCallback,  	gensym("pname"), A_DEFFLOAT, A_NULL);
	 class_addmethod(classPtr, (t_method)&GEMglPixelStoref::paramMessCallback,  	gensym("param"), A_DEFFLOAT, A_NULL);
};
