...
CPPEXTERN_NEW_WITH_TWO_ARGS ( GEMglPixelStoref, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglPixelStoref :: GEMglPixelStoref    (t_floatarg arg0,
    t_floatarg arg1) :
...
void GEMglPixelStoref :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglPixelStoref::pnameMessCallback),
                  gensym("pname"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglPixelStoref::paramMessCallback),
