...
GEMglMap2f :: GEMglMap2f        (int argc, t_atom *argv) :
  target(0),
  u1(0.f), u2(0.f), ustride(0), uorder(0),
  v1(0.f), v2(0.f), vstride(0), vorder(0),
  points(0), len(0)
{
  if (argc>0) {
  ...
  if (argc>1) {
    u1     =static_cast<GLfloat>(atom_getfloat(argv+1));
  }
  if (argc>2) {
    u2     =static_cast<GLfloat>(atom_getfloat(argv+2));
  }
  if (argc>3) {
  ...
  if (argc>5) {
    v1     =static_cast<GLfloat>(atom_getfloat(argv+5));
  }
  if (argc>6) {
    v2     =static_cast<GLfloat>(atom_getfloat(argv+6));
  }
  if (argc>7) {
...
void GEMglMap2f :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglMap2f::targetMessCallback),
                  gensym("target"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglMap2f::u1MessCallback),     gensym("u1"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglMap2f::u2MessCallback),     gensym("u2"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglMap2f::ustrideMessCallback),
                  gensym("ustride"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglMap2f::uorderMessCallback),
                  gensym("uorder"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglMap2f::v1MessCallback),     gensym("v1"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglMap2f::v2MessCallback),     gensym("v2"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglMap2f::vstrideMessCallback),
                  gensym("vstride"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglMap2f::vorderMessCallback),
                  gensym("vorder"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglMap2f::pointsMessCallback),
                  gensym("points"), A_GIMME, A_NULL);
}

void GEMglMap2f :: targetMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->targetMess ( static_cast<t_float>(arg0));
}
void GEMglMap2f :: u1MessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->u1Mess ( static_cast<t_float>(arg0));
}
void GEMglMap2f :: u2MessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->u2Mess ( static_cast<t_float>(arg0));
}
void GEMglMap2f :: ustrideMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->ustrideMess ( static_cast<t_float>(arg0));
}
void GEMglMap2f :: uorderMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->uorderMess ( static_cast<t_float>(arg0));
}
void GEMglMap2f :: v1MessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->v1Mess ( static_cast<t_float>(arg0));
}
void GEMglMap2f :: v2MessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->v2Mess ( static_cast<t_float>(arg0));
}
void GEMglMap2f :: vstrideMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->vstrideMess ( static_cast<t_float>(arg0));
}
void GEMglMap2f :: vorderMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->vorderMess ( static_cast<t_float>(arg0));
}
void GEMglMap2f :: pointsMessCallback (void* data, t_symbol*, int argc,
                                       t_atom*argv)
{
