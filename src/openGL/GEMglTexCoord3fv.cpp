...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglTexCoord3fv, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglTexCoord3fv :: GEMglTexCoord3fv    (t_floatarg arg0, t_floatarg arg1,
    t_floatarg arg2)
{
...
// variable
//
void GEMglTexCoord3fv :: vMess (t_float arg0, t_float arg1,
                                t_float arg2)       // FUN
{
...
void GEMglTexCoord3fv :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord3fv::vMessCallback),
                  gensym("v"), A_DEFFLOAT, A_DEFFLOAT, A_DEFFLOAT, A_NULL);
}

void GEMglTexCoord3fv :: vMessCallback (void* data, t_float arg0,
