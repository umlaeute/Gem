...
CPPEXTERN_NEW_WITH_TWO_ARGS ( GEMglTexCoord2fv, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglTexCoord2fv :: GEMglTexCoord2fv    (t_floatarg arg0, t_floatarg arg1)
{
  vMess(arg0, arg1);
...
void GEMglTexCoord2fv :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglTexCoord2fv::vMessCallback),
                  gensym("v"), A_DEFFLOAT, A_DEFFLOAT, A_NULL);
}

void GEMglTexCoord2fv :: vMessCallback (void* data, t_float arg0,
                                        t_float arg1)
{
