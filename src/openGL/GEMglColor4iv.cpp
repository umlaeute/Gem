...
CPPEXTERN_NEW_WITH_FOUR_ARGS ( GEMglColor4iv, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglColor4iv :: GEMglColor4iv  (t_floatarg arg0, t_floatarg arg1,
...
// variable
//
void GEMglColor4iv :: vMess (t_float arg0, t_float arg1, t_float arg2,
                             t_float arg3)    // FUN
{
...
void GEMglColor4iv :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglColor4iv::vMessCallback),   gensym("v"),
                  A_DEFFLOAT, A_DEFFLOAT, A_DEFFLOAT, A_DEFFLOAT, A_NULL);
}

void GEMglColor4iv :: vMessCallback (void* data, t_float arg0,
