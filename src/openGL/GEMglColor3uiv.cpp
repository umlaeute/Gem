...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglColor3uiv, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglColor3uiv :: GEMglColor3uiv        (t_floatarg arg0, t_floatarg arg1,
    t_floatarg arg2)
{
...
// variable
//
void GEMglColor3uiv :: vMess (t_float arg0, t_float arg1,
                              t_float arg2)         // FUN
{
...
void GEMglColor3uiv :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglColor3uiv::vMessCallback),
                  gensym("v"), A_DEFFLOAT, A_DEFFLOAT, A_DEFFLOAT, A_NULL);
}

void GEMglColor3uiv :: vMessCallback (void* data, t_float arg0,
