...
CPPEXTERN_NEW_WITH_FOUR_ARGS ( GEMglVertex4f, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglVertex4f :: GEMglVertex4f  (t_floatarg arg0, t_floatarg arg1,
...
void GEMglVertex4f :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex4f::xMessCallback),   gensym("x"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex4f::yMessCallback),   gensym("y"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex4f::zMessCallback),   gensym("z"),
                  A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex4f::wMessCallback),   gensym("w"),
                  A_DEFFLOAT, A_NULL);
};

void GEMglVertex4f :: xMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->xMess ( static_cast<t_float>(arg0));
}
void GEMglVertex4f :: yMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->yMess ( static_cast<t_float>(arg0));
}
void GEMglVertex4f :: zMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->zMess ( static_cast<t_float>(arg0));
}
void GEMglVertex4f :: wMessCallback (void* data, t_float arg0)
{
