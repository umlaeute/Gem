...
CPPEXTERN_NEW_WITH_TWO_ARGS ( GEMglVertex2sv, t_floatarg, A_DEFFLOAT,
...
void GEMglVertex2sv :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglVertex2sv::vMessCallback),
                  gensym("v"), A_DEFFLOAT, A_DEFFLOAT, A_NULL);
}

void GEMglVertex2sv :: vMessCallback (void* data, t_float arg0,
                                      t_float arg1)
{
