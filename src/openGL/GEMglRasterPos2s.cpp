...
void GEMglRasterPos2s :: obj_setupCallback(t_class *classPtr) {
	 class_addmethod(classPtr, (t_method)&GEMglRasterPos2s::xMessCallback,  	gensym("x"), A_DEFFLOAT, A_NULL);
	 class_addmethod(classPtr, (t_method)&GEMglRasterPos2s::yMessCallback,  	gensym("y"), A_DEFFLOAT, A_NULL);
};
