...
CPPEXTERN_NEW_WITH_FOUR_ARGS ( GEMglRasterPos4d, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglRasterPos4d :: GEMglRasterPos4d    (t_floatarg arg0, t_floatarg arg1,
...
void GEMglRasterPos4d :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos4d::xMessCallback),
                  gensym("x"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos4d::yMessCallback),
                  gensym("y"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos4d::zMessCallback),
                  gensym("z"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos4d::wMessCallback),
                  gensym("w"), A_DEFFLOAT, A_NULL);
};

void GEMglRasterPos4d :: xMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->xMess ( static_cast<t_float>(arg0));
}
void GEMglRasterPos4d :: yMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->yMess ( static_cast<t_float>(arg0));
}
void GEMglRasterPos4d :: zMessCallback (void* data, t_float arg0)
{
  GetMyClass(data)->zMess ( static_cast<t_float>(arg0));
}
void GEMglRasterPos4d :: wMessCallback (void* data, t_float arg0)
{
