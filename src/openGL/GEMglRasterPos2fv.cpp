...
CPPEXTERN_NEW_WITH_TWO_ARGS ( GEMglRasterPos2fv, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglRasterPos2fv :: GEMglRasterPos2fv  (t_floatarg arg0, t_floatarg arg1)
{
  vMess(arg0, arg1);
...
void GEMglRasterPos2fv :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos2fv::vMessCallback),
                  gensym("v"), A_DEFFLOAT, A_DEFFLOAT, A_NULL);
}

void GEMglRasterPos2fv :: vMessCallback (void* data, t_float arg0,
    t_float arg1)
{
