...
CPPEXTERN_NEW_WITH_FOUR_ARGS ( GEMglRasterPos4s, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglRasterPos4s :: GEMglRasterPos4s    (t_floatarg arg0, t_floatarg arg1,
...
void GEMglRasterPos4s :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos4s::xMessCallback),
                  gensym("x"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos4s::yMessCallback),
                  gensym("y"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos4s::zMessCallback),
                  gensym("z"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos4s::wMessCallback),
