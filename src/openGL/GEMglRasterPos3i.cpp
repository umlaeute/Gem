...
CPPEXTERN_NEW_WITH_THREE_ARGS ( GEMglRasterPos3i, t_floatarg, A_DEFFLOAT,
...
// Constructor
//
GEMglRasterPos3i :: GEMglRasterPos3i    (t_floatarg arg0, t_floatarg arg1,
    t_floatarg arg2) :
...
void GEMglRasterPos3i :: obj_setupCallback(t_class *classPtr)
{
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos3i::xMessCallback),
                  gensym("x"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos3i::yMessCallback),
                  gensym("y"), A_DEFFLOAT, A_NULL);
  class_addmethod(classPtr,
                  reinterpret_cast<t_method>(&GEMglRasterPos3i::zMessCallback),
