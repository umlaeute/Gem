...
#ifndef INCLUDE_GEM_GLEVALCOORD2DV_H_
#define INCLUDE_GEM_GLEVALCOORD2DV_H_
...
class GEM_EXTERN GEMglEvalCoord2dv : public GemBase
{
	CPPEXTERN_HEADER(GEMglEvalCoord2dv, GemBase)
