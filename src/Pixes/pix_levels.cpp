...
void pix_levels :: Pete_Levels_SetupCFSettings(int colour)
{
  ...
  if (m_DoUniform) {
    ...
    if (m_DoAllowInversion) {
      ...
      if (nBlueInputDelta==0) {
        nBlueInputDelta=1;
      }
      if (nBlueOutputDelta==0) {
        nBlueOutputDelta=1;
      }
      if (nAlphaInputDelta==0) {
        nAlphaInputDelta=1;
      }
      if (nAlphaOutputDelta==0) {
        nAlphaOutputDelta=1;
      }
  ...
  while (pCurrentSource<pSourceEnd) {
    ...
    while (pCurrentSource<pSourceLineEnd) {
      ...
      case (GEM_GRAY):
        ...
        nRedHistogram  [nSourceAlpha]+=1;
        nGreenHistogram[nSourceRed] +=1;
        nGreenHistogram[nSourceGreen]+=1;
        nGreenHistogram[nSourceBlue]+=1;
        nGreenHistogram[nSourceAlpha]+=1;
        nBlueHistogram [nSourceRed] +=1;
        nBlueHistogram [nSourceGreen]+=1;
        nBlueHistogram [nSourceBlue]+=1;
        nBlueHistogram [nSourceAlpha]+=1;
        nAlphaHistogram[nSourceRed] +=1;
        nAlphaHistogram[nSourceGreen]+=1;
