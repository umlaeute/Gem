...
void pix_composite :: processRGBA_MMX(imageStruct &image, imageStruct &right)
{
  ...
  while(datasize--)    {
    ...
    l1=_mm_unpackhi_pi8(l0, nil);
    r1=_mm_unpackhi_pi8(r0, nil);
    l0=_mm_unpacklo_pi8(l0, nil);
    r0=_mm_unpacklo_pi8(r0, nil);
    b =_mm_unpackhi_pi8(a , nil);
    a =_mm_unpacklo_pi8(a , nil);
