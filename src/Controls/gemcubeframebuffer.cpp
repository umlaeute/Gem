...
//
/////////////////////////////////////////////////////////
gemcubeframebuffer :: ~gemcubeframebuffer()
{
  destroyFBO();
...
//
/////////////////////////////////////////////////////////
void gemcubeframebuffer :: postrender(GemState *state)
{
  t_float w, h;
  gem::GLStack*stacks=NULL;
  if(state) {
...
//
/////////////////////////////////////////////////////////
void gemcubeframebuffer :: bangMess()
{
...
//
/////////////////////////////////////////////////////////
void gemcubeframebuffer :: startRendering()
{
  m_wantinit = true;
}
...
//
/////////////////////////////////////////////////////////
void gemcubeframebuffer :: stopRendering()
{
  destroyFBO();
}
...
void gemcubeframebuffer :: formatMess(std::string format)
{
  GLenum tmp_format=0;
  if("YUV"==format) {
...
void gemcubeframebuffer :: typeMess(std::string type)
{
  if("FLOAT"==type) {
    m_type = GL_FLOAT;
  } else {
...
void gemcubeframebuffer :: rectangleMess(bool rectangle)
{
...
//
////////////////////////////////////////////////////////
void gemcubeframebuffer :: obj_setupCallback(t_class *classPtr)
{
  ...
  CPPEXTERN_MSG1(classPtr, "face",   faceMess, int);
