...
/*-----------------------------------------------------------------
  ...
  render to offscreen buffer and make cubemap texture
  ...
  -----------------------------------------------------------------*/
class GEM_EXTERN gemcubeframebuffer : public GemBase
{
...
protected:
  ...
  virtual void faceMess(int face);
