...
#ifndef INCLUDE_PART_VELDOMAIN_H_
#define INCLUDE_PART_VELDOMAIN_H_
...
/*-----------------------------------------------------------------
  ...
  -----------------------------------------------------------------*/
class GEM_EXTERN part_veldomain : public GemBase
{
  CPPEXTERN_HEADER(part_veldomain, GemBase)

    public:

  //////////
  // Constructor
  part_veldomain(int,t_atom*);
