...
#ifndef INCLUDE_YUV_MOVIE_H_
#define INCLUDE_YUV_MOVIE_H_
...
/*-----------------------------------------------------------------
  ...
  -----------------------------------------------------------------*/
#ifdef _WINDOWS
class GEM_EXTERN yuv_movie : public pix_filmNT
{
  CPPEXTERN_HEADER(yuv_movie, pix_filmNT)
#elif __linux__
class GEM_EXTERN yuv_movie : public pix_filmLinux
{
  CPPEXTERN_HEADER(yuv_movie, pix_filmLinux)
#elif MACOSX
class GEM_EXTERN yuv_movie : public yuv_filmDarwin
{
    CPPEXTERN_HEADER(yuv_movie, yuv_filmDarwin)
#endif
