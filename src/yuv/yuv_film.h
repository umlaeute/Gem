...
#ifndef INCLUDE_YUV_FILM_H_
#define INCLUDE_YUV_FILM_H_
...
/*-----------------------------------------------------------------
  ...
  -----------------------------------------------------------------*/
class GEM_EXTERN yuv_film : public GemBase
{
  CPPEXTERN_HEADER(yuv_film, GemBase)
    
    public:
  
  //////////
  // Constructor
  yuv_film(t_symbol *filename);
  //  yuv_film();
