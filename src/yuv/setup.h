...
extern "C" {
   ...
   void yuv_video_setup();
   void yuv_videoDarwin_setup();
   void yuv_gain_setup();
   ...
   void yuv_pixel_average_setup();
   void yuv_posterize_setup();
   void yuv_set_setup();
   void yuv_subtract_setup();
   void yuv_split_setup();
   void yuv_swap_setup();
   void yuv_mask_setup();
   void yuv_mix_setup();
//   void yuv_feedback_setup();
   void yuv_blur_setup();
