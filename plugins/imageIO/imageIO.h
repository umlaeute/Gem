...
/*-----------------------------------------------------------------
  ...
  image loading backend for GEM using the ImageIO framework
  image writing backend for GEM using the ImageIO framework

-----------------------------------------------------------------*/

#ifndef _INCLUDE_GEMPLUGIN__IMAGEIO_IMAGEIO_H_
...
namespace plugins
{
class GEM_EXPORT imageIO
  : public gem::plugins::imageloader
